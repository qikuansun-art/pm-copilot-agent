"""Demonstrate planning after requirement understanding and clarification."""
...
def main() -> None:
    """Run the CNC task through the first planning transition."""
    state = AgentState(
        task=TaskContext(
            task_id="planner-demo",
            title="CNC 刀具管理规划",
    ...
    result = runtime.create_plan(state)
